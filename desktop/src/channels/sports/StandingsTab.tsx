  ...
  switch (sport) {
    case "soccer":
      return [
        ...
        { ...teamCol, width: "w-40" },
        { key: "gp", label: "GP", width: "w-10", align: "center", getValue: (s) => s.games_played },
        { key: "w", label: "W", width: "w-10", align: "center", getValue: (s) => s.wins },
        { key: "d", label: "D", width: "w-10", align: "center", getValue: (s) => s.draws },
        { key: "l", label: "L", width: "w-10", align: "center", getValue: (s) => s.losses },
        { key: "gd", label: "GD", width: "w-12", align: "center", getValue: (s) => s.goal_diff > 0 ? `+${s.goal_diff}` : s.goal_diff },
        { key: "pts", label: "Pts", width: "w-12", align: "center", getValue: (s) => s.points },
        { key: "form", label: "Form", width: "w-16", getValue: (s) => s.form || "-" },
      ];
    case "nfl":
      return [
        { key: "rank", label: "#", width: "w-8", align: "center", getValue: (s) => s.rank || "-" },
        ...
        { key: "w", label: "W", width: "w-10", align: "center", getValue: (s) => s.wins },
        { key: "l", label: "L", width: "w-10", align: "center", getValue: (s) => s.losses },
        { key: "t", label: "T", width: "w-10", align: "center", getValue: (s) => s.draws },
        { key: "pct", label: "Pct", width: "w-14", align: "center", getValue: (s) => s.pct || "-" },
        { key: "pf", label: "PF", width: "w-12", align: "center", getValue: (s) => s.points_for || "-" },
        { key: "pa", label: "PA", width: "w-12", align: "center", getValue: (s) => s.points_against || "-" },
        { key: "streak", label: "Str", width: "w-14", getValue: (s) => s.streak || "-" },
      ];
    case "nba":
    case "mlb":
      return [
        ...
        { key: "l", label: "L", width: "w-10", align: "center", getValue: (s) => s.losses },
        { key: "pct", label: "Pct", width: "w-14", align: "center", getValue: (s) => s.pct || "-" },
        { key: "gb", label: "GB", width: "w-14", align: "center", getValue: (s) => s.games_behind || "-" },
        { key: "pf", label: "PF", width: "w-12", align: "center", getValue: (s) => s.points_for || "-" },
        { key: "pa", label: "PA", width: "w-12", align: "center", getValue: (s) => s.points_against || "-" },
        { key: "streak", label: "Str", width: "w-14", getValue: (s) => s.streak || "-" },
      ];
    case "nhl":
      return [
        ...
        { key: "w", label: "W", width: "w-10", align: "center", getValue: (s) => s.wins },
        { key: "l", label: "L", width: "w-10", align: "center", getValue: (s) => s.losses },
        { key: "otl", label: "OTL", width: "w-10", align: "center", getValue: (s) => s.otl ?? "-" },
        { key: "pts", label: "Pts", width: "w-12", align: "center", getValue: (s) => s.points },
        { key: "gf", label: "GF", width: "w-12", align: "center", getValue: (s) => s.goals_for ?? "-" },
        { key: "ga", label: "GA", width: "w-12", align: "center", getValue: (s) => s.goals_against ?? "-" },
        { key: "streak", label: "Str", width: "w-14", getValue: (s) => s.streak || "-" },
      ];
    default:
      return [
