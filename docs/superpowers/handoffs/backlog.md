...
- [ ] **Multi-monitor support.** The user wants the ticker (and presumably the main app window) to be aware of which monitor it lives on, save monitor selection across launches, and Just Work when monitors are added/removed/reconfigured. Brainstorming in progress in the next session.
