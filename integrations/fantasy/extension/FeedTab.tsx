 ...
 * is registered in the extension's channel registry so the tab
 * appears when a user has a fantasy channel, but the actual UI is
  ...
  return (
    <div className="flex items-center justify-center py-10 px-4 bg-surface">
      <div className="text-center space-y-3">
        ...
        <p className="text-xs font-mono text-fg-2 uppercase tracking-wider">
          Fantasy
        </p>
        <p className="text-[11px] text-fg-3 max-w-[220px] leading-relaxed">
          Fantasy league data is best viewed on the Scrollr dashboard. Visit{" "}
          <span className="text-accent/60 font-mono">myscrollr.com</span> for
