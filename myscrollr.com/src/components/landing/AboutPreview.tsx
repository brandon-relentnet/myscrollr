      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        >
          ...
          <p className="text-lg text-base-content/60 leading-relaxed max-w-lg">
            Scrollr started with a simple question: why do we have to switch
            tabs to see the score? It evolved into an overlay engine for anyone
            who needs data without the distraction.
          </p>
        ...
        >
          <div className="relative aspect-video rounded-sm border border-base-300/50 bg-base-200/50 backdrop-blur-xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {/* Outer ring */}
              <div className="w-40 h-40 rounded-full border border-primary/20 flex items-center justify-center animate-spin-slow">
                {/* Inner ring */}
                <div className="w-28 h-28 rounded-full border border-secondary/30 flex items-center justify-center animate-spin-reverse-slow">
                  {/* Center dot */}
            ...
            <div className="absolute top-4 left-4 px-3 py-1.5 rounded-sm bg-base-300/80 backdrop-blur-sm text-[10px] font-bold font-mono text-primary border border-primary/20 shadow-lg flex items-center gap-2 animate-float">
              <span className="relative flex h-1.5 w-1.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75" />
                <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary" />
              </span>
            ...
            <div className="absolute bottom-4 right-4 px-3 py-1.5 rounded-sm bg-base-300/80 backdrop-blur-sm text-[10px] font-bold font-mono text-secondary border border-secondary/20 shadow-lg animate-float-reverse">
              CONNECTED
            </div>
