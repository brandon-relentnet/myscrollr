...
// ── Git log commits (migrated from AboutPreview) ──

const COMMITS = [
  {
    hash: 'a3f8d2c',
    msg: 'feat: yahoo fantasy integration',
    color: 'text-primary/50',
  },
  {
    hash: '7e1b4a9',
    msg: 'feat: rss feed aggregation',
    color: 'text-info/50',
  },
  {
    hash: 'b2c9e1f',
    msg: 'fix: cdc routing per-feed-url',
    color: 'text-secondary/50',
  },
  {
    hash: 'd4a7c3b',
    msg: 'feat: sports espn polling',
    color: 'text-primary/50',
  },
  {
    hash: 'f9e2d8a',
    msg: 'feat: finance finnhub ws',
    color: 'text-info/50',
  },
  {
    hash: '1c6b3e7',
    msg: 'feat: sse real-time pipeline',
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-5xl mx-auto mb-12">
          ...
          <motion.div
            ...
            className="group relative bg-base-200/40 border border-base-300/50 rounded-sm overflow-hidden"
          >
            {/* Hover glow */}
            ...
            <div className="relative z-10 p-8 lg:p-10">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="h-10 w-10 rounded-sm bg-primary/8 border border-primary/15 flex items-center justify-center text-primary">
                  <Code2 size={18} />
                </div>
                <div>
              ...
              {/* Git log visual */}
              <div className="relative rounded-sm border border-base-300/40 bg-base-100/50 overflow-hidden mb-6">
                ...
                <div className="p-4 font-mono text-[10px] space-y-2.5">
                  {COMMITS.map((commit, i) => (
                    ...
                    >
                      <span className="text-warning/30 shrink-0">
                        {commit.hash}
                      </span>
                      <span className={`${commit.color} truncate`}>
                        {commit.msg}
                      </span>
                    </motion.div>
                  ))}
          ...
          >
            ...
            <div className="relative z-10 p-8 lg:p-10">
              {/* Header */}
              <div className="flex items-center gap-3 mb-6">
                <div className="h-10 w-10 rounded-sm bg-info/8 border border-info/15 flex items-center justify-center text-info">
                  <Lightbulb size={18} />
                </div>
                <div>
              ...
              <div className="rounded-sm border border-base-300/40 bg-base-100/50 p-5 mb-6">
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  {COMING_SOON_ICONS.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-sm bg-base-200/60 border border-base-300/30"
                    >
                      <span className="text-sm leading-none">{item.emoji}</span>
                      <span className="text-[10px] font-mono text-base-content/30 truncate">
                        {item.name}
                      </span>
                    </motion.div>
                  ))}
                ...
                <motion.div
                  ...
                  className="mt-2.5 flex items-center justify-center gap-2 px-3 py-2.5 rounded-sm border border-dashed border-primary/20 bg-primary/[0.03] text-primary/40 hover:text-primary/60 hover:border-primary/30 transition-colors cursor-default"
                >
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 px-8 py-5 rounded-sm bg-base-200/30 border border-base-300/30">
            {/* Trust signals */}
            <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] font-mono text-base-content/25 uppercase tracking-wider">
